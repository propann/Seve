  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <section className="mx-auto max-w-5xl px-6 py-24">
        <p className="text-xs uppercase tracking-[0.3em] text-amber-200/80">Azoth | Graine Linux</p>
        <h1 className="mt-4 font-serif text-5xl text-white md:text-6xl">Presentation Linux</h1>
        <p className="mt-6 text-slate-300 max-w-3xl">
          Cette graine est prete pour les tests de vote et de navigation. Le contenu detaille sera construit dans l atelier de creation.
        </p>
